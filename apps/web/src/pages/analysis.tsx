...
export function AnalysisPage() {
  ...
  const browserAudioUrl = localStorage.getItem(`soniccritique:audio:${id}`);
  ...
  return (
    <div className="space-y-4">
      {browserAudioUrl ? (
        <audio controls className="w-full" src={browserAudioUrl} />
      ) : (
        <Card>
          <p className="text-sm text-zinc-300">Audio playback unavailable. Re-upload the file to listen again.</p>
        </Card>
      )}
